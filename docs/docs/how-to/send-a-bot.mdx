...
<Tabs>
  ...
  <Tab title="Yandex Telemost">
    ...
    witnessed live on a compose stack**. The bot joins as a guest, so with the waiting room on (the
    default for Yandex 360 organisations) the organiser admits it.
